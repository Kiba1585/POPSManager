    ...
    public partial class SettingsView : UserControl
    {
        ...
        private void ChangePopsPath_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (dlg.ShowDialog() == CommonFileDialogResult.Ok)
            {
                ...
                Services.Notify(new UiNotification(NotificationType.Success, "Ruta POPS actualizada"));
            }
        }
        ...
        private void ChangeAppsPath_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (dlg.ShowDialog() == CommonFileDialogResult.Ok)
            {
                ...
                Services.Notify(new UiNotification(NotificationType.Success, "Ruta APPS actualizada"));
            }
        }
        ...
        private void DarkModeToggle_Checked(object sender, RoutedEventArgs e)
        {
            ...
            Services.Notify(new UiNotification(NotificationType.Info, "Modo oscuro activado"));
        }

        private void DarkModeToggle_Unchecked(object sender, RoutedEventArgs e)
        {
            Services.Settings.DarkMode = false;
            Services.Notify(new UiNotification(NotificationType.Info, "Modo oscuro desactivado"));
        }
        ...
        private void NotificationsToggle_Checked(object sender, RoutedEventArgs e)
        {
            ...
            Services.Notify(new UiNotification(NotificationType.Info, "Notificaciones activadas"));
        }

        private void NotificationsToggle_Unchecked(object sender, RoutedEventArgs e)
        {
            Services.Settings.NotificationsEnabled = false;
            Services.Notify(new UiNotification(NotificationType.Info, "Notificaciones desactivadas"));
        }
