...
namespace POPSManager.Logic
{
    public class GameProcessor
    {
        ...
        private void ProcessSingle(string vcdPath)
        {
            ...
            string popsFolder = Path.Combine(App.Services.Paths.PopsFolder, gameId);
        ...
        {
            // PS1: SCES_123.45 → SCES_123.45
            // PS2: SLUS-12345 → SLUS_12345
        ...
        private void GenerateElf(string gameId, string folder)
        {
            ...
            try
            {
                // Aquí llamas a tu generador real
